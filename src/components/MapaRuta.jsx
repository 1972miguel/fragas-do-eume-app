...
// === FIX ICONOS EN PRODUCCIÓN (importante) ===
...
// Puntos reales de la ruta (más fiel a Wikiloc)
const routePoints = [
  [43.405356, -8.048852],
  [43.405271, -8.048859],
  [43.404955, -8.049645],
...
// Marcadores clave con nombres (más puntos que antes)
const keyMarkers = [
  { pos: [43.405356, -8.048852], label: "Inicio - Central da Ventureira" },
...
export default function MapaRuta() {
  ...
  const [mapCenter] = useState([43.417, -8.068]); // Centro de la ruta
